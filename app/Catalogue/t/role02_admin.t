...
$ua1->get_ok( '/login?username=test04&password=mypass',
    'Login in with user role' );

my @list_allowed = qw(
    applications    category2    columns
    databases       dataextract datarequest
    datareview      datasets    erid
    extract_approval    igadmin kpe
    registration    schemas     supplier
    tables          tasks       users
