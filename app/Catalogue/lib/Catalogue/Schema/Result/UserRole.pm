use utf8;
package Catalogue::Schema::Result::UserRole;
...
Related object: L<Catalogue::Schema::Result::Role>

=cut

__PACKAGE__->belongs_to(
  "role",
  "Catalogue::Schema::Result::Role",
  { id => "role_id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ou+/UYJkVOqWGYvVceRz1g
